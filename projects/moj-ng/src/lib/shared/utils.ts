...
import { MojLanguage, MojDirection, LANGUAGES } from '../elements/website/language';
...
export class MojUtilsService {
    ...
    async initialize(configFile: string): Promise<any> {
        ...
        return Promise.all([
            this.languageService.loadTranslations(null,this.config),
    ...
    setSubmitToFormGroup(formGroup: NgForm | FormGroup, clearSubmited: boolean = false) {
        Object.keys(formGroup.controls).forEach(key => {
            ...
            if (control instanceof FormGroup) {
                ...
                let submitted = !clearSubmited ? true : false;
                (<any>control).submitted = submitted;
