...
import { MojDynamicFontsize } from '../../directives/dynamic-font-size.directive';
...
@NgModule({
    imports: [CommonModule, TranslateModule, MojPipesModule, RouterModule, ValidationsModule,MojLineModule,MojDirectiveModule],
    exports: [MojAccessibleMenuComponent, MojWebsiteTopmenuComponent, MojWebsiteTopmenuMainItemComponent, MojWebsiteTopmenuSubItemComponent,
        MojWebsiteHeaderComponent, MojWebsiteFooterComponent, StickyAlertComponent, MojRecaptchaComponent,MojWebsiteSupportContainerComponent, MojRecaptchaDirective,
