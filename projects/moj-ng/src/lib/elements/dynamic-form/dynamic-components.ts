...
@Component({
    selector: "moj-dynamic-slider",
    template: `<div [formGroup]="group"><moj-slider #innerComponent [formControlName]="name"></moj-slider></div>`,
})
export class MojDynamicSliderComponent extends MojDynamicComponent {
