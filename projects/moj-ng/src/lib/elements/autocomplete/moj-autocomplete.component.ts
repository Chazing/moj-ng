...
export class MojAutoCompleteComponent extends DropDownBase {
    ...
    search(event) {
                    ...
                    this.http
                        ...
                        .subscribe(items => {
                            if (items) {
                                ...
                                this.pAutoComplete.suggestions = this.filteredItems;//bug 381366 - if items not change suggestions not updated
        ...
        } else if (this.items && this.itemsValue.length) {
            if (this.fieldName && this.itemsValue[0].hasOwnProperty(this.fieldName)) {
                // objects array
                ...
                // srtings array
                this.filteredItems = this.itemsValue.filter(item => this.a(event, item));
            }
        }
