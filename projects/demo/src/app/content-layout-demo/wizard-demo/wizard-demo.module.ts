...
import { MojWizardModule, MojInputModule, MojSharedModule, MojGuidelinesModule } from "@moj/moj-ng";
import { RouterModule } from "@angular/router";

@NgModule({
    declarations: [WizardDemoComponent, Step1Component, Step2Component, Step3Component, Step4Component],
    imports: [CommonModule, MojWizardModule, MojInputModule, MojSharedModule, MojGuidelinesModule, RouterModule.forChild([
