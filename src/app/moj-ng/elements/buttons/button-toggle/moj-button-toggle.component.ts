import { Component, Input, Output, EventEmitter, ChangeDetectionStrategy, OnInit, ChangeDetectorRef, ElementRef, Injector } from "@angular/core";
    ...
    ngOnInit() {
        ...
        this.items.forEach((element, i) => {
            if (element.id) {
                ...
                this.items[i].disabled = !permissionResult.enable;
