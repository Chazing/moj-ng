...
export class GridService {
    constructor(private translate: TranslateService, private utils: MojUtilsService, private permissionService: PermissionService) { }

    getMojGridOptions(isMultiSelect: boolean = false) {
        let mojGridOptions: GridOptions = {};
        mojGridOptions.rowHeight = 33;
        mojGridOptions.enableRtl = this.utils.currentLang.dir === MojDirection.rtl ? true : false;
    ...
    getMojColumn(field: string, mojColDef: MojColDef = {}): ColDef {
        ...
        let dir = this.utils.currentLang.dir === MojDirection.rtl ? "rtl" : "ltr";
        colDef.cellRenderer = function (params) {
            var value = params.value || params.value == 0 ? params.value : '';
    ...
    getMojCheckBoxColumn(field: string, mojCheckBoxColDef: MojCheckBoxColDef = { headerSelection: true }, name: string): ColDef {
        let colDef: ColDef = this.setDefaultsToColDef({
            field: field,
