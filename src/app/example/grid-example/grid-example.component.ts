...
import { MojGridPanelComponent } from "../../moj-ng/elements/grid/moj-grid-panel";
...
export class GridExampleComponent implements OnInit {
    ...
    @ViewChild('grid1') grid:MojGridPanelComponent;

    constructor(private gridExampleService: GridExampleService,
        private http: HttpClient, private gridService: GridService,
    ...
    ngOnInit() {
        ...
        this.columns1 = [
            ...
            this.gridService.getEditColumn({headerName:"edit",cssClass:"orange2",disabled:true}),
        ...
        this.columns2 = [
            ...
            this.gridService.getMojIconColumn(null,{ icon: { iconClass: "far fa-smile orange2 font-22", tooltip: "please smile!" } }),
            this.gridService.getMojIconColumn(null,{ icon: { field: "UnitPrice", iconClass: "far fa-arrow-alt-circle-down orange1", clickLink: this.clickLink }, iconWithText: true }),
            this.gridService.getMojIconColumn(null,{ icon: this.getIcon, iconWithText: true, colDef: { headerName: 'dynamic' } })
        ];
