...
@Component({
    selector: "moj-guidelines-example",
    templateUrl: "guidelines-example.component.html",
    styleUrls:['guidelines-example.component.scss']
})
export class GuidelinesExampleComponent {
    guidelines = [
